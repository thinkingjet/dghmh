      ...
      $.ajax({
        ...
        success: function () {
          ...
          $("#subscribe2-success > .alert-success")
            ...
            .append("</button>");
          $("#subscribe2-success > .alert-success").append(
            "<strong>Your message has been sent. </strong>"
          );
          $("#subscribe2-success > .alert-success").append("</div>");
        ...
        error: function () {
          ...
          $("#subscribe2-success > .alert-danger")
            .html(
              "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;"
            )
            .append("</button>");
          $("#subscribe2-success > .alert-danger").append(
